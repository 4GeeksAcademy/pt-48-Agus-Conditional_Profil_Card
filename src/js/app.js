...
function render(variables = {}) {
  ...
  let cover2 = `<div class="cover2"><img src="${variables.avatarURL}" class="photo" /></div>`;
  if (variables.includeProfilePicture == false)
    cover2 = `<div class="cover2"></div>`;

  // reset the website body with the new html output <img src="${variables.avatarURL}" class="photo" />
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition} id="socialMedia">
